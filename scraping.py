...
def main():
    # List of 50 hotels with locations
    # hotel_list = [
    #     ("Hilton", "New York"), ("Marriott", "London"), ("Sheraton", "Paris"), ("Ritz-Carlton", "Tokyo"), ("Four Seasons", "Sydney"),
    #     ("Waldorf Astoria", "Dubai"), ("Mandarin Oriental", "Hong Kong"), ("InterContinental", "Singapore"), ("Fairmont", "San Francisco"), ("Hyatt Regency", "Chicago"),
    #     ("Grand Hyatt", "Seoul"), ("Shangri-La", "Bangkok"), ("Peninsula", "Manila"), ("Raffles", "Istanbul"), ("St. Regis", "Mexico City"),
    ...
    #     ("The Broadmoor", "Colorado Springs"), ("The Phoenician", "Scottsdale"), ("The Cloister", "Sea Island"), ("The Lodge", "Pebble Beach"), ("The Inn at", "Little Washington"),
    ...
    #     ("The Mission Inn", "Riverside"), ("The Fairmont", "San Francisco"), ("The Palace Hotel", "San Francisco"), ("The St. Francis", "San Francisco"), ("Hilton", "London")
    # ]
    hotel_list = [
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=2) as executor:
        ...
        for future in concurrent.futures.as_completed(futures, timeout=1000):  # 10-minute timeout
